...
exports.WorkloadPatternAnalyzer = void 0;
const winston = __importStar(require("winston"));
class WorkloadPatternAnalyzer {
    constructor() {
        this.patterns = new Map();
        this.metricsHistory = [];
        this.maxHistorySize = 10000; // Keep last 10k metrics points
    ...
    async analyzeAndCreatePatterns(metrics, serviceId) {
        try {
    ...
    async predictUsingPatterns(serviceId, currentTime = new Date()) {
        try {
    ...
    async getOptimalScalingSchedule(serviceId) {
        try {
    ...
    async analyzeDailyPattern(metrics, serviceId) {
        try {
    ...
    async analyzeWeeklyPattern(metrics, serviceId) {
        try {
    ...
    async analyzeSeasonalPatterns(metrics, serviceId) {
        // This would implement more sophisticated seasonal analysis
        // For now, return empty array
        return [];
    }
    async analyzeSpikePatterns(metrics, serviceId) {
        try {
    ...
    async generatePredictionFromPattern(pattern, targetTime) {
        try {
    ...
    predictFromDailyPattern(pattern, targetTime) {
    ...
    predictFromWeeklyPattern(pattern, targetTime) {
    ...
    predictFromSpikePattern(pattern, targetTime) {
...
exports.WorkloadPatternAnalyzer = WorkloadPatternAnalyzer;
//# sourceMappingURL=WorkloadPatternAnalyzer.js.map