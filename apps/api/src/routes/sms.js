...
var SMSAgent_js_1 = require("../agents/SMSAgent.js");
var http_js_1 = require("../lib/http.js");
exports.smsRouter = (0, express_1.Router)();
var sendSchema = zod_1.z.object({
    personId: zod_1.z.string().min(1),
    objective: zod_1.z.string().min(1),
    brandId: zod_1.z.string().min(1),
});
exports.smsRouter.post("/send", auth_js_1.requireAuth, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var payload, args, error_1, message;
    var _a, _b, _c, _d;
    return __generator(this, function (_e) {
        switch (_e.label) {
            case 0:
                ...
                return [4 /*yield*/, SMSAgent_js_1.smsAgent.send(args)];
            case 1:
                _e.sent();
            ...
            case 2:
                ...
                message = error_1 instanceof Error ? error_1.message : "Failed to send SMS";
                return [2 /*return*/, res.status(message.includes("consent") ? 403 : 500).json((0, http_js_1.fail)(message).body)];
            case 3: return [2 /*return*/];
        }
    });
}); });
exports.smsRouter.post("/inbound", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var inbound, error_2, message;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                inbound = req.body;
                return [4 /*yield*/, SMSAgent_js_1.smsAgent.parseReply(inbound)];
            case 1:
                _a.sent();
                return [2 /*return*/, res.json((0, http_js_1.ok)({ received: true }))];
            case 2:
                error_2 = _a.sent();
                message = error_2 instanceof Error ? error_2.message : "Failed to process inbound SMS";
                return [2 /*return*/, res.status(500).json((0, http_js_1.fail)(message).body)];
            case 3: return [2 /*return*/];
        }
    });
}); });
exports.default = exports.smsRouter;
