/**
 * TypeScript Types for Governance API Integrations
 * Provides type safety across all v6.0 governance modules
 */
...
export interface ComplianceValidationResult {
  allowed: boolean;
  violations: string[];
  governance?: GovernancePolicyEvaluation;
...
export interface FederatedTaskRouting {
  route: RoutingResult;
  governance?: GovernancePolicyEvaluation;
  energyImpact?: ResourceOptimization;
}

export interface FederatedSessionMonitoring {
  health: SystemHealth;
  governance: GovernanceHealthStatus;
  sustainability: EnergyMetrics;
}
