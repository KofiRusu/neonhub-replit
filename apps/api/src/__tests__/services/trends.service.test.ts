...
describe("trends.service", () => {
  beforeEach(() => {
    ...
    ;(socialApiClient.aggregateTrends as unknown as jest.Mock).mockResolvedValue(mockTrends)
    ;(socialApiClient.fetchTwitterTrends as unknown as jest.Mock).mockResolvedValue(mockTrends.filter((t) => t.platform === "twitter"))
    ;(socialApiClient.fetchRedditTrends as unknown as jest.Mock).mockResolvedValue(mockTrends.filter((t) => t.platform === "reddit"))
  })
  ...
  it("filters trends by platform", async () => {
    ...
    expect(socialApiClient.aggregateTrends).toHaveBeenCalled()
  })
