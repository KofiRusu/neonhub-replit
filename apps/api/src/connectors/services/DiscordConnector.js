...
function discordFetch(auth_1, path_1) {
    return __awaiter(this, arguments, void 0, function (auth, path, init) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    token = auth.apiKey || auth.accessToken;
                    if (!token)
                        throw new Error("Discord connector requires a bot token");
                    return [4 /*yield*/, fetch("https://discord.com/api/v10/".concat(path), __assign(__assign({}, init), { headers: __assign({ Authorization: "Bot ".concat(token), "Content-Type": "application/json" }, (init.headers || {})) }))];
                case 1:
                    response = _a.sent();
                ...
                case 2:
                    text = _a.sent();
                    throw new Error("Discord API error ".concat(response.status, ": ").concat(text));
                case 3:
...
var DiscordConnector = /** @class */ (function (_super) {
                ...
                execute: function (_a) { return __awaiter(_this, [_a], void 0, function (_b) {
                    ...
                    return __generator(this, function (_c) {
                        ...
                        return [2 /*return*/, RetryManager_js_1.retryManager.run(function () {
                                return discordFetch(auth, "channels/".concat(payload.channelId, "/messages"), {
                                    method: "POST",
    ...
    DiscordConnector.prototype.testConnection = function (auth) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, discordFetch(auth, "users/@me", { method: "GET" })];
                    case 1:
                        _b.sent();
