...
var createTaskSchema = zod_1.z.object({
    workspaceGid: zod_1.z.string().min(1),
...
var listTasksSchema = zod_1.z.object({
    projectGid: zod_1.z.string().optional(),
    sectionGid: zod_1.z.string().optional(),
    assignee: zod_1.z.string().optional(),
    limit: zod_1.z.number().min(1).max(50).default(20),
});
function asanaFetch(auth_1, path_1) {
    return __awaiter(this, arguments, void 0, function (auth, path, init) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!auth.accessToken)
                        throw new Error("Asana connector requires an access token");
                    return [4 /*yield*/, fetch("https://app.asana.com/api/1.0/".concat(path), __assign(__assign({}, init), { headers: __assign({ Authorization: "Bearer ".concat(auth.accessToken), "Content-Type": "application/json" }, (init.headers || {})) }))];
                case 1:
                    response = _a.sent();
                ...
                case 2:
                    text = _a.sent();
                    throw new Error("Asana API error ".concat(response.status, ": ").concat(text));
...
var AsanaConnector = /** @class */ (function (_super) {
    __extends(AsanaConnector, _super);
        ...
        _this.actions = [
            {
                ...
                execute: function (_a) { return __awaiter(_this, [_a], void 0, function (_b) {
                    ...
                    return __generator(this, function (_c) {
                        payload = createTaskSchema.parse(input);
                        return [2 /*return*/, RetryManager_js_1.retryManager.run(function () {
                                return asanaFetch(auth, "tasks", {
                                    method: "POST",
                                    body: JSON.stringify({
                                        data: {
        ...
        _this.triggers = [
            {
                ...
                run: function (_a) { return __awaiter(_this, [_a], void 0, function (_b) {
                    ...
                    return __generator(this, function (_e) {
                        switch (_e.label) {
                            case 0:
                                payload = listTasksSchema.parse(settings !== null && settings !== void 0 ? settings : {});
                                params = new URLSearchParams({
                                    limit: String(payload.limit),
                                    opt_fields: "name,completed,assignee,status,modified_at",
                                });
                                if (payload.projectGid)
                                    params.set("project", payload.projectGid);
                                if (payload.sectionGid)
                                    params.set("section", payload.sectionGid);
                                if (payload.assignee)
                                    params.set("assignee.any", payload.assignee);
                                if (cursor)
                                    params.set("offset", cursor);
                                return [4 /*yield*/, asanaFetch(auth, "tasks?".concat(params.toString()), { method: "GET" })];
                            case 1:
                                result = _e.sent();
                                return [2 /*return*/, {
                                        cursor: (_d = (_c = result.next_page) === null || _c === void 0 ? void 0 : _c.offset) !== null && _d !== void 0 ? _d : null,
                                        items: result.data,
                                    }];
                        }
                    });
    ...
    AsanaConnector.prototype.testConnection = function (auth) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, asanaFetch(auth, "users/me", { method: "GET" })];
                    case 1:
                        _b.sent();
