...
exports.GoogleSearchConsoleConnector = void 0;
var Connector_js_1 = require("../base/Connector.js");
var GoogleSearchConsoleConnector = /** @class */ (function (_super) {
    __extends(GoogleSearchConsoleConnector, _super);
    function GoogleSearchConsoleConnector() {
    ...
    GoogleSearchConsoleConnector.prototype.testConnection = function (auth) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, Boolean(auth.accessToken)];
            });
        });
    };
    return GoogleSearchConsoleConnector;
}(Connector_js_1.Connector));
exports.GoogleSearchConsoleConnector = GoogleSearchConsoleConnector;
