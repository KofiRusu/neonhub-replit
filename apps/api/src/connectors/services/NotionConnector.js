...
var createPageSchema = zod_1.z.object({
    parentDatabaseId: zod_1.z.string().min(1),
    title: zod_1.z.string().min(1),
    properties: zod_1.z.record(zod_1.z.unknown()).optional(),
    content: zod_1.z.string().optional(),
});
var queryDatabaseSchema = zod_1.z.object({
    databaseId: zod_1.z.string().min(1),
    filter: zod_1.z.record(zod_1.z.unknown()).optional(),
});
function notionFetch(auth_1, path_1) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, fetch("https://api.notion.com/v1/".concat(path), __assign(__assign({}, init), { headers: __assign({ Authorization: "Bearer ".concat(auth.accessToken), "Content-Type": "application/json", "Notion-Version": "2022-06-28" }, (init.headers || {})) }))];
                case 1:
                    response = _a.sent();
                ...
                case 2:
                    text = _a.sent();
                    throw new Error("Notion API error ".concat(response.status, ": ").concat(text));
...
var NotionConnector = /** @class */ (function (_super) {
    __extends(NotionConnector, _super);
        ...
        _this.actions = [
            {
                ...
                execute: function (_a) { return __awaiter(_this, [_a], void 0, function (_b) {
                    ...
                    return __generator(this, function (_d) {
                        payload = createPageSchema.parse(input);
                        body = {
                            parent: { database_id: payload.parentDatabaseId },
                            properties: (_c = payload.properties) !== null && _c !== void 0 ? _c : {
                                Title: {
        ...
        _this.triggers = [
            {
                ...
                run: function (_a) { return __awaiter(_this, [_a], void 0, function (_b) {
                    ...
                    return __generator(this, function (_c) {
                        switch (_c.label) {
                            case 0:
                                payload = queryDatabaseSchema.parse(settings !== null && settings !== void 0 ? settings : {});
                                body = {
                                ...
                                return [4 /*yield*/, notionFetch(auth, "databases/".concat(payload.databaseId, "/query"), {
                                        method: "POST",
                                        body: JSON.stringify(__assign(__assign({}, body), { start_cursor: cursor || undefined })),
                                    })];
                            case 1:
                                result = _c.sent();
                                return [2 /*return*/, {
    ...
    NotionConnector.prototype.testConnection = function (auth) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, notionFetch(auth, "users/me", { method: "GET" })];
                    case 1:
                        _b.sent();
