...
var whatsappSendInput = zod_1.z.object({
...
var whatsappTemplateInput = zod_1.z.object({
    to: zod_1.z.string().min(1, "Recipient phone number is required"),
    templateName: zod_1.z.string().min(1, "Template name is required"),
    params: zod_1.z.array(zod_1.z.string()).default([]),
    languageCode: zod_1.z.string().default("en_US"),
    from: zod_1.z.string().optional(),
    statusCallbackUrl: zod_1.z.string().url().optional(),
});
var whatsappStatusInput = zod_1.z.object({
    messageId: zod_1.z.string().min(1, "Message SID is required"),
});
var whatsappMetadataSchema = zod_1.z.object({
...
function resolveTwilioCredentials(auth) {
    var _a, _b, _c, _d;
    var metadata = whatsappMetadataSchema.parse((_a = auth.metadata) !== null && _a !== void 0 ? _a : {});
    ...
    if (!accountSid) {
        throw new Error("WhatsApp connector requires a Twilio account SID (provide via apiKey or metadata.accountSid)");
    }
    if (!authToken) {
        throw new Error("WhatsApp connector requires a Twilio auth token (provide via apiSecret, accessToken, or metadata.authToken)");
    }
    return {
...
function ensureWhatsappPrefix(value) {
    return value.startsWith("whatsapp:") ? value : "whatsapp:".concat(value);
}
function renderTemplateMessage(templateName, params, languageCode) {
    if (params.length === 0) {
        return "[".concat(languageCode, "] ").concat(templateName);
    }
    return "[".concat(languageCode, "] ").concat(templateName, ": ").concat(params.join(", "));
}
...
var WhatsAppConnector = /** @class */ (function (_super) {
    __extends(WhatsAppConnector, _super);
    function WhatsAppConnector() {
        var _this = _super.call(this, {
            ...
            authType: "api_key",
            authConfig: {
                instructions: "Provide your Twilio Account SID as the API key and Auth Token as the API secret. Optionally supply a default WhatsApp From number via metadata.fromNumber.",
            },
        }) || this;
        _this.actions = [
            {
                ...
                execute: function (_a) { return __awaiter(_this, [_a], void 0, function (_b) {
                    ...
                    return __generator(this, function (_d) {
                        switch (_d.label) {
                            case 0:
                                payload = whatsappSendInput.parse(input);
            ...
            },
            {
                ...
                execute: function (_a) { return __awaiter(_this, [_a], void 0, function (_b) {
                    ...
                    return __generator(this, function (_d) {
                        switch (_d.label) {
                            case 0:
                                payload = whatsappTemplateInput.parse(input);
                                creds = resolveTwilioCredentials(auth);
                                fromNumber = (_c = payload.from) !== null && _c !== void 0 ? _c : creds.defaultFrom;
                                if (!fromNumber) {
                                    throw new Error("WhatsApp connector requires a from number (provide in input.from or metadata.fromNumber)");
                                ...
                                bodyParams.set("PersistentAction", "template_name=".concat(payload.templateName));
                                if (payload.statusCallbackUrl) {
                                    bodyParams.set("StatusCallback", payload.statusCallbackUrl);
                                }
                                return [4 /*yield*/, RetryManager_js_1.retryManager.run(function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            },
            {
                ...
                execute: function (_a) { return __awaiter(_this, [_a], void 0, function (_b) {
                    ...
                    return __generator(this, function (_d) {
                        switch (_d.label) {
                            case 0:
                                payload = whatsappStatusInput.parse(input);
                                creds = resolveTwilioCredentials(auth);
                                return [4 /*yield*/, RetryManager_js_1.retryManager.run(function () { return __awaiter(_this, void 0, void 0, function () {
                                        return __generator(this, function (_a) {
    ...
    WhatsAppConnector.prototype.testConnection = function (auth) {
