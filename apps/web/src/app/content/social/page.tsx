    ...
    <div className="min-h-screen bg-gradient-to-br from-[#0F1120] via-[#13152A] to-[#0F1120]">
      ...
      <div className="p-8">
        <NeonCard className="p-8 text-center">
          <Hash className="w-16 h-16 text-[#2B26FE] mx-auto mb-4" />
          <h2 className="text-xl font-semibold text-[#E6E8FF] mb-2">Social Media Content</h2>
          <p className="text-[#8A8FB2]">Create engaging social media posts</p>
        </NeonCard>
      </div>
    </div>
  )
