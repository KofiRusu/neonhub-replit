...
export interface MeshNode {
  ...
  byzantineScore: number; // 0-100, higher is more trustworthy
}
...
export interface SelfReconstructionConfig {
  ...
  reconstructionThreshold: number; // percentage of nodes that must agree
...
export interface MeshResilienceConfig {
  ...
  maxPartitionDuration: number; // seconds
