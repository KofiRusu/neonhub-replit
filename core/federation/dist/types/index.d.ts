...
export declare enum FederationMessageType {
    HEARTBEAT = "heartbeat",
...
export declare enum FederationErrorCode {
...
export declare enum IntelligenceAggregationAlgorithm {
    FED_AVG = "fed_avg",
    FED_PROX = "fed_prox",
...
export declare enum SecureComputationProtocol {
...
export declare enum IntelligenceSharingType {
...
export declare enum AIXMessageType {
    MODEL_SUMMARY_EXCHANGE = "model_summary_exchange",
    INTELLIGENCE_SHARING_REQUEST = "intelligence_sharing_request",
    KNOWLEDGE_DISTILLATION = "knowledge_distillation",
    INTELLIGENCE_AGGREGATION = "intelligence_aggregation",
