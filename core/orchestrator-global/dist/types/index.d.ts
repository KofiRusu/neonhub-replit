...
export declare enum GlobalCapability {
    ROUTING = "routing",
    SCALING = "scaling",
    FAILOVER = "failover",
...
export declare class GlobalOrchestratorError extends Error {
    code: GlobalOrchestratorErrorCode;
    nodeId?: string;
    federationId?: string;
    details?: any;
    constructor(code: GlobalOrchestratorErrorCode, message: string, nodeId?: string, federationId?: string, details?: any);
}
export declare enum GlobalOrchestratorErrorCode {
...
export declare enum FederationStatus {
    ACTIVE = "active",
    INACTIVE = "inactive",
