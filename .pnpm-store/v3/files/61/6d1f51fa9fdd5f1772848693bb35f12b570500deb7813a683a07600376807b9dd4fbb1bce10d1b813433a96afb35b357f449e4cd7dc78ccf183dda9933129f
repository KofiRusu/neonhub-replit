...
exports.KubernetesAutoscaler = void 0;
...
class KubernetesAutoscaler {
    ...
    async getCurrentMetrics() {
        try {
            ...
            const response = await axios_1.default.get(`${this.neonHubApiUrl}/api/metrics/current`);
...
exports.KubernetesAutoscaler = KubernetesAutoscaler;
