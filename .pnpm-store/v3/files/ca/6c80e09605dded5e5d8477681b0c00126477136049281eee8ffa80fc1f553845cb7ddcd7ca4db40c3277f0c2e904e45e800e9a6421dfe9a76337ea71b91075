...
export class BaselineLoader {
  private static readonly BASELINE_DIR = path.join(__dirname, '../../../');

  static async loadV31Baseline(): Promise<PerformanceMetrics> {
  ...
  static async loadV30Baseline(): Promise<PerformanceMetrics> {
  ...
  static async loadCSVBaseline(filePath: string): Promise<any[]> {
